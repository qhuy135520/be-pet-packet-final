...
public class OtpResetPasswordService {
	...
	public ResponseEntity<?> validate(SignUpRequest signUpRequest, OtpRequest otpRequest) {
		...
		if (signUpRequest == null || !signUpRequest.getEmail().equals(otpRequest.getEmail())) {
			ErrorResponse errorResponse = new ErrorResponse("Registration information is invalid or expired",
